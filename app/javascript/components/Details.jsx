        ...
        return(
            <div className={`absolute h-full right-0 w-1/4 ${task === null ? 'hidden' : 'visible'} p-3 overflow-y-auto transition-opacity duration-500 ease-in-out bg-white border border-gray-300`}>
                <div class="flex items-center justify-between">
                    <textarea
                        className="h-8 p-0 text-2xl font-semibold text-gray-600 line-through border-none resize-none focus:p-2 focus:border-2 focus:border-gray-600 focus:outline-none focus:ring-0"
                        type="text"
                        name="task"
                ...
                <div className="flex items-center justify-between mt-2 mb-4 group">
                    ...
                    <h4 className="flex items-center text-base font-normal text-gray-400">UX/UI</h4>
                </div>
                {/* Projects */}
